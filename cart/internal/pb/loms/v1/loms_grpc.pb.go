...
func (c *lomsClient) OrderInfo(ctx context.Context, in *OrderInfoRequest, opts ...grpc.CallOption) (*OrderInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/route256.loms.pkg.api.loms.v1.Loms/OrderInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderCreate(ctx context.Context, in *OrderCreateRequest, opts ...grpc.CallOption) (*OrderCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/route256.loms.pkg.api.loms.v1.Loms/OrderCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderPay(ctx context.Context, in *OrderPayRequest, opts ...grpc.CallOption) (*OrderPayResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/route256.loms.pkg.api.loms.v1.Loms/OrderPay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderCancel(ctx context.Context, in *OrderCancelRequest, opts ...grpc.CallOption) (*OrderCancelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/route256.loms.pkg.api.loms.v1.Loms/OrderCancel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) StockInfo(ctx context.Context, in *StockInfoRequest, opts ...grpc.CallOption) (*StockInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/route256.loms.pkg.api.loms.v1.Loms/StockInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Loms_OrderInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/route256.loms.pkg.api.loms.v1.Loms/OrderInfo",
	}
...
func _Loms_OrderCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/route256.loms.pkg.api.loms.v1.Loms/OrderCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_OrderPay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/route256.loms.pkg.api.loms.v1.Loms/OrderPay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_OrderCancel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/route256.loms.pkg.api.loms.v1.Loms/OrderCancel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_StockInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/route256.loms.pkg.api.loms.v1.Loms/StockInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Loms_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "route256.loms.pkg.api.loms.v1.Loms",
